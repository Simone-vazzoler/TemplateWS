...
public class Funzioni {
    ...
    public Vector<Update> getUpdates()
    {
     ...
     //metodo che ottiene coordinate da web service e restituisce un oggetto Posizione
    ...
    //metodo per leggere contenuto di un url
    ...
    //salvo su csv oggetto con coordinate
